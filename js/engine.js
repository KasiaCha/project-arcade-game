...
var Engine = (function(global) {
     ...
     */
    function update(dt) {
        // Referrenced https://discussions.udacity.com/t/finite-state-machine-to-model-game-states/21955
        ...
        case "startGame":
            ...
            for (row = 0; row < numRows; row++) {
                for (col = 0; col < numCols; col++) {
                    ...
                    ctx.fillStyle = "black";
                    ctx.font = "35px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("Press Enter to Start", canvas.width/2, canvas.height/3.2);


                    ctx.fillStyle = "black";
                    ctx.font = "25px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("Use Arrows to Move", canvas.width/2, canvas.height/2.7);


                    ctx.fillStyle = "black";
                    ctx.font = "30px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("Collect priceless stars!", canvas.width/2, canvas.height/2.0);


                    ctx.fillStyle = "black";
                    ctx.font = "30px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("Watch for falling rocks!", canvas.width/2, canvas.height/1.8);
        ...
        case "gameOver":
            ...
            for (row = 0; row < numRows; row++) {
                for (col = 0; col < numCols; col++) {
                    ...
                    ctx.font = "30px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("You were smashed by rocks!", canvas.width/2, canvas.height/3.0);

                    ctx.fillStyle = "black";
                    ctx.font = "25px Faster One";
                    ctx.textAlign = "center";
                    ctx.fillText("Press Enter to Restart Game", canvas.width/2, canvas.height/2.0);
                }
            }
            break;
     ...
     */
     ...
     // This function allows for game to be reset 
     function reset() {
